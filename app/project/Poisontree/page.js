...
export default function PoisonTreeCaseStudy() {
  return (
    <section className="w-full bg-[#0f0f11] text-white px-4 sm:px-6 md:px-10 py-16 sm:py-20 relative overflow-hidden">
      <div className="max-w-6xl mx-auto w-full relative">

        {/* Back Arrow Button */}
        <button className="absolute top-4 left-4 text-white text-xl p-2 rounded-full hover:bg-white/10 transition z-10">
          <FiArrowLeft />
        </button>

        {/* Breadcrumb
        <div className="text-xs sm:text-sm text-gray-400 mb-8 pt-12 sm:pt-16">
          <span className="text-white/60">Home &gt; Portfolio &gt; </span>
          <span className="text-white font-semibold">Poison Tree (B2C Mood based App)</span>
        </div> */}
  ...
  <span className="text-white font-semibold">Poison Tree (B2C Mood based App)</span>
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-6 leading-tight">
          Poison Tree (B2C <br className="hidden sm:block" /> Mood based App)
        </h1>

        {/* Description */}
        <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed max-w-4xl mb-16">
          Poison Tree is an emotionally-driven social app that lets users share moods and thoughts anonymously through poetic micro-posts. 
          Designed with a surreal, david lynchish, distraction-free UI, it offers a calming space to express feelings without the pressure of social validation.
          The interface blends smooth transitions and ambient design to immerse users in their emotions. Ideal for those seeking quiet digital refuge over loud social feeds.
        </p>
        ...
        {/* Tech + Link */}
        <div className="flex flex-col md:flex-row justify-between gap-6 border-t border-[#2f2f2f] pt-6 mb-20">
          <div>
            <h3 className="text-gray-400 text-sm uppercase tracking-wide mb-1">Technologies</h3>
            <p className="text-white text-base">Next.js, MongoDB, TailwindCSS, Framer Motion, Vercel</p>
          </div>
        ...
        <div className="space-y-10 mb-24">
          {['1', '2', '3', '4'].map((img) => (
            <img
              ...
              src={`/${img}.png`}
              alt={`Screenshot ${img}`}
              className="rounded-xl shadow-md w-full max-h-[600px] object-cover object-top"
            />
          ))}
        </div>
        ...
        <div className="mb-32 space-y-12">
          <div>
            ...
            <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
              Most platforms for expression are noisy and overly social. I wanted something quiet, david lynch, introspective — like Tumblr and Pinterest had a surreal baby.
            </p>
          </div>
          ...
          {/* CTA */}
          <div className="border-t border-gray-700 pt-10">
            <h2 className="text-xl sm:text-2xl font-bold mb-4">Want something like this for your idea?</h2>
            <a
              href="mailto:yuv1n.ashrith@gmail.com"
              className="inline-block px-6 py-3 bg-purple-600 text-white rounded-md font-semibold hover:bg-purple-700 transition text-sm sm:text-base"
            >
              Let’s Work Together
            </a>
          </div>
      ...
      {/* Next Project Floating Box */}
  <div className="fixed bottom-6 right-4 sm:right-10 z-50">
      <div className="bg-white text-black rounded-xl px-4 sm:px-5 py-4 shadow-lg w-[250px] sm:w-[280px]">
